...
void LangSettings::init() {
	...
	data[LS_FORCE_SEMICOLON			 ].Set("force_semicolon",			false,
		"Controlar el uso de ; al final de sentencias secuenciales",
			...
			"en lenguajes como C++ o Pascal (útil para acostumbrarse antes de dar el salto desde el pseudocódigo a un lenguaje real). "
	...
	data[LS_ALLOW_ACCENTS].Set("allow_accents",							true,
		"Permitir utilizar acentos en nombres de variables",
			...
			"acento, diéresis (por ejemplo ü como en \"pingüino\") y/o la letra ñ. Si está desactivada, el uso de estas letras generará errores de "
