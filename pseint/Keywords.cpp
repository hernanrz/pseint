...
/// @todo:  reemplazar por alguna otra func mas espec�fica
...
void initKeywords(KeywordsList &keywords) {
	...
	keywords[KW_DIMENSIONAR] = "Dimensionar,Dimension";
	keywords[KW_REDIMENSIONAR] = "Redimensionar,Redimension";
	keywords[KW_DEFINIR] = "Definir";
	keywords[KW_COMO] = "Como";
	keywords[KW_TIPO_ENTERO] = "Entero,Entera,Enteros,Enteras";
	keywords[KW_TIPO_REAL] = "Real,Reales,Número,Numero,Números,Numeros,Numérica,Numerica,Numéricas,Numericas,Numérico,Numerico,Numéricos,Numericos";
	keywords[KW_TIPO_LOGICO] = "Lógico,Logico,Lógica,Logica,Lógicos,Logicos,Lógicas,Logicas";
...
void fixKeywords(KeywordsList &keywords, const LangSettings & lang) {
	...
	if (lang[LS_PREFER_FUNCION]) {
		keywords[KW_SUBALGORITMO] += "Función, Funcion";
		keywords[KW_FINSUBALGORITMO] += "FinFunción, FinFuncion, Fin Función, Fin Funcion";
	}
	if (not lang[LS_PREFER_ALGORITMO]) {
